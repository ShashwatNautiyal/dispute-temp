...
const HealthBar: Component<{
  ...
  return (
    <div class="flex w-[220px] h-[40px] gap-[4px]">
      <Show when={props.showArrows ?? true}>
      ...
      <div class="flex flex-col w-full h-[40px] gap-[4px]">
        <div class="flex h-[20px] font-[500] text-[13px] text-[#494949]">
          {props.number}
        </div>
        <div class="flex items-center w-full justify-between h-[16px] gap-[8px]">
          <div class="flex items-center h-[12px] gap-[2px]">
          ...
          <div class="flex h-[16px] text-[13px] text-[#494949]">
            {props.percentage}%
          </div>
        </div>
      </div>
